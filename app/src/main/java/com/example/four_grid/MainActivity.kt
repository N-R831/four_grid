...
import com.example.four_grid.ui.theme.Four_gridTheme
...
@Composable
fun FourGrid(modifier: Modifier = Modifier) {
    Column(Modifier.fillMaxWidth()) {
        Row (modifier = Modifier.weight(1f)){
            FourGridParts(
                stringResource(R.string.first_title),
                stringResource(R.string.first_scription),
                Color(0xFFEADDFF),
...
@Composable
fun FourGridParts(title: String, description: String, backgroundColor: Color, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
